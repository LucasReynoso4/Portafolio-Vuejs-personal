...
const educacion = ref([
  {fecha: '2024', title: 'Estudiante en la Técnicatura Universitaria en Programacion', descripcion: 'Objetivo: Deseo recibirme para poder usar mis conocimientos profesionales en mi actual trabajo en el Banco de la Nacion Argentina.', enlace:'https://www.youtube.com/'},
  {fecha: '2022', title: 'Curso JavaScript y React Js', descripcion: 'Dicte un curso de JavaScript y React Js por CoderHouse, ademas de adquirir conocimientos de economia y programacion por mi cuenta por los demas años. '},
...
ul li .fecha {
  ...
  font-size: 1.45rem; /* Tamaño del texto */
