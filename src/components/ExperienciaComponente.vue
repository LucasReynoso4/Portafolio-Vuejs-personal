...
import { ref } from 'vue';
const titulo = 'Desarrollador Jr';
const fecha = 'Desde Enero 2021 / Noviembre 2024';
const experiencias = ref([
    { id: 1, src: icono2, parrafo: 'Diseñé y desarrollé aplicaciones web y juegos utilizando Python y React .' },
    { id: 2, src: icono4, parrafo: 'Empleado en BNA Gestion de Activos.' },
    { id: 3, src: icono5, parrafo: 'Termine la escuela secundaria en el Instituto Sendas Verdes .' },
]);
</script>
