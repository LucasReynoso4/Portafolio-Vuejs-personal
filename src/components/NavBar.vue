...
.navbar {
    ...
    color: #b36464; /* Establece el color del texto en blanco */
...
.navbar-menu {
    ...
    justify-content: flex-start; /* Alinea los elementos al final de la navbar */
}
...
a {
    ...
    padding: 10px; /* Añade un padding de 5px alrededor del contenido */
}
