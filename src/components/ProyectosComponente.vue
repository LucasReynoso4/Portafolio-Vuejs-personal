...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Juego de plataformas Python",
        descripcion: "Creé un juego de plataformas con Pygame para un proyecto de la UTN",
        projectoLink: "https://github.com/LucasReynoso4/pygame_main",
        githubLink: "https://github.com/LucasReynoso4/pygame_main"
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Juego Preguntados",
        descripcion: "Desarrollé un juego similar al Preguntados con Pygame",
        projectoLink: "https://github.com/LucasReynoso4/preguntados",
        githubLink: "https://github.com/LucasReynoso4/preguntados"
    },
...
.galeria {
    ...
    background: linear-gradient(-45deg, #ace708, #6fc420, #49863d, #4b4b36);
